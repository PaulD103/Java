...
class MAMPFISYMBOL extends MampfiDarstellungImpl
{
    ...
    public MAMPFISYMBOL()
    {
        ...
        startWinkel = (int) super.StartWinkelGeben();
        bogenWinkel = (int) super.BogenWinkelGeben();
        bogenArt = super.BogenArtGeben();
        fuellFarbe = "gelb";
        randFarbe = "gelb";
     ...
     */
    public void StartWinkelSetzen(int winkelNeu)
    {   
     ...
     * @param winkelNeu der neue Wert
     */
    public void BogenWinkelSetzen(int winkelNeu)
    {
     ...
     * 2 - Kuchenstueck
     */
    public void BogenArtSetzen(int bogenArtNeu)
    {
